...
const iata =['NCE', 'ODS', 'IEV', "KBP", "HRK", "DNK", "LWO", "IFO", "IST", "SAW", "FRA", "MUC", "BER", "LGW", "LHR", "LTN", "TBS", "DXB", "VIE", "BUD", "MSQ", "KUT", "EVN", "ZRH", "WAW", "CDG", "OZH", "TLV", "MIA", "GZT", "VNO", "YYZ", "YVR", "BUS", "BCN", "AYT", "AMS", "PRG", "KIV", "ALA", 'ESB', 'FCO', 'NQZ', 'JFK', 'LGA', 'LCY', 'BEG', 'ZAG', 'GZP', 'SKG', 'ATH', 'HER', 'LCA', 'BOJ', 'SPU','DLM'];
const latin =['Ницца', 'Одесса', 'Киев(Жуляны)', 'Киев(Борисполь)', 'Харьков', 'Днепр', 'Львов', 'Ивано-Франковск', 'Стамбул(Новый)',  'Стамбул(Сабиха)', 'Франкфурт', 'Мюнхен', 'Берлин', 'Лондон(Гатвик)', 'Лондон(Хитроу)', 'Лондон(Лутон)', 'Тбилиси', 'Дубай', 'Вена', 'Будапешт', 'Минск', 'Кутаиси', 'Ереван', 'Цюрих', 'Варшава', 'Париж (Шарль-де-Голь)', 'Запорожье', 'Тель-Авив', 'Майами', 'Газиантеп', 'Вильнюс', 'Торонто', 'Ванкувер', 'Батуми', 'Барселона', 'Анталия', 'Амстердам', 'Прага', 'Кишенёв', 'Алмааты','Анкара', 'Рим(фьюмичино)', 'Нурсултан Назарбаев', 'Нью-Йорк(Кенеди)', 'Нью-Йорк(Ла Гуардия)', 'Лондон(Сити)', 'Белград', 'Загреб', 'Газипаша', 'Салоники', 'Афины', 'Ираклион', 'Ларнака', 'Бургас', 'Сплит', 'Даламан'];
